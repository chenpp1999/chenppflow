...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser()    # 生成parser
    parser = pl.Trainer.add_argparse_args(parser)  # 将parser传入pl.trainer
...
#     parser.add_argument("--log_path", type=str, default=None, help="Path to the output console log file")
    ...
    parser = getattr(utils.data, temp_args.settings.capitalize() + "DataModule").add_data_specific_arguments(parser)  # 文件里的函数，capitalize()将变量名首字母大写其他小写
